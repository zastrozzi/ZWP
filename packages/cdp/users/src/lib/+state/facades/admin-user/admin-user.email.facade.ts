...
export class AdminUserEmailFacade {
    ...
    adminUserEmailRemoteState$ = this.store.pipe(select(Selectors.AdminUserEmailSelectors.selectAdminUserEmailRemoteState))
    adminUserEmailRemoteStateBusy$ = this.store.pipe(select(Selectors.AdminUserEmailSelectors.selectAdminUserEmailRemoteStateBusy))
