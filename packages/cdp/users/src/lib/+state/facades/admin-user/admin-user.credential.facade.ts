...
export class AdminUserCredentialFacade {
    ...
    adminUserCredentialRemoteState$ = this.store.pipe(select(Selectors.AdminUserCredentialSelectors.selectAdminUserCredentialRemoteState))
    adminUserCredentialRemoteStateBusy$ = this.store.pipe(select(Selectors.AdminUserCredentialSelectors.selectAdminUserCredentialRemoteStateBusy))
