...
export class AdminUserActivityFacade {
    ...
    adminUserActivity$ = this.store.pipe(select(Selectors.AdminUserActivitySelectors.selectAllAdminUserActivities))
    ...
    adminUserActivityWithAdminUser$ = this.store.pipe(
        select(Selectors.AdminUserActivitySelectors.selectAllAdminUserActivitiesWithAdminUser),
        map((activities) => {
