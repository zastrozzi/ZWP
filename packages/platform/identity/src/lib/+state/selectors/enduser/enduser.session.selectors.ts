...
const selectFilteredEnduserSessions = createSelector(
    ...
    (sessions, filters) => selectFilteredElements(sessions, filters, Model.Filters.enduserSessionFilterEntityMap)
)

const selectPaginatedEnduserSessions = createSelector(
    selectAllEnduserSessions,
    selectEnduserSessionRemotePagination,
    (sessions, pagination) => selectPaginatedElements(sessions, pagination)
)

const selectPaginatedFilteredEnduserSessions = createSelector(
    selectFilteredEnduserSessions,
    selectEnduserSessionRemotePagination,
    (sessions, pagination) => selectPaginatedElements(sessions, pagination)
)

const selectEnduserSessionsForSelectedEnduser = createSelector(
    EnduserSelectors.selectSelectedEnduserId,
    selectAllEnduserSessions,
    (selectedEnduserId, sessions) => sessions.filter(session => session.enduserId === selectedEnduserId)
)

const selectEnduserSessionsForEnduser = (enduserId: string) => createSelector(
    selectAllEnduserSessions,
    (sessions) => sessions.filter(session => session.enduserId === enduserId)
)

const selectFilteredEnduserSessionsForSelectedEnduser = createSelector(
    selectEnduserSessionsForSelectedEnduser,
    selectEnduserSessionFilters,
    (sessions, filters) => selectFilteredElements(sessions, filters, Model.Filters.enduserSessionFilterEntityMap)
)

const selectPaginatedEnduserSessionsForSelectedEnduser = createSelector(
    selectEnduserSessionsForSelectedEnduser,
    selectEnduserSessionRemotePagination,
    (sessions, pagination) => selectPaginatedElements(sessions, pagination)
)

const selectPaginatedFilteredEnduserSessionsForSelectedEnduser = createSelector(
    selectFilteredEnduserSessionsForSelectedEnduser,
    selectEnduserSessionRemotePagination,
    (sessions, pagination) => selectPaginatedElements(sessions, pagination)
)
...
export const EnduserSessionSelectors = {
    ...
    selectFilteredEnduserSessions,
    selectPaginatedEnduserSessions,
    selectPaginatedFilteredEnduserSessions,
    selectEnduserSessionsForSelectedEnduser,
    selectEnduserSessionsForEnduser,
    selectFilteredEnduserSessionsForSelectedEnduser,
    selectPaginatedEnduserSessionsForSelectedEnduser,
    selectPaginatedFilteredEnduserSessionsForSelectedEnduser,
