...
export interface EnduserAddressFeatureState extends BaseRemoteFeatureState {
    ...
    filters: Model.Filters.EnduserAddressFilters
}
...
export const initialEnduserAddressFeatureState: EnduserAddressFeatureState = {
    ...
    filters: Model.Filters.initialEnduserAddressFilters
}
...
export const enduserAddressReducer = createReducer(
    ...
    on(
        ...
        (state, { response }) => ({ 
            ...state, 
            enduserAddresses: enduserAddressEntityAdapter.setMany(response.results, state.enduserAddresses),
