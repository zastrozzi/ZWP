...
export interface EnduserEmailFeatureState extends BaseRemoteFeatureState {
    ...
    filters: Model.Filters.EnduserEmailFilters
}
...
export const initialEnduserEmailFeatureState: EnduserEmailFeatureState = {
    ...
    filters: Model.Filters.initialEnduserEmailFilters
}
...
export const enduserEmailReducer = createReducer(
    ...
    on(
        ...
        (state, { response }) => ({ 
            ...state,
            enduserEmails: enduserEmailEntityAdapter.setMany(response.results, state.enduserEmails),
