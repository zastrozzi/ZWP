...
export interface EnduserPhoneFeatureState extends BaseRemoteFeatureState {
    ...
    filters: Model.Filters.EnduserPhoneFilters
}
...
export const initialEnduserPhoneFeatureState: EnduserPhoneFeatureState = {
    ...
    filters: Model.Filters.initialEnduserPhoneFilters
}
...
export const enduserPhoneReducer = createReducer(
    ...
    on(
        ...
        (state, { response }) => ({ 
            ...state,
            enduserPhones: enduserPhoneEntityAdapter.setMany(response.results, state.enduserPhones),
