...
export interface EnduserCredentialFeatureState extends BaseRemoteFeatureState {
    ...
    filters: Model.Filters.EnduserCredentialFilters
}
...
export const initialEnduserCredentialFeatureState: EnduserCredentialFeatureState = {
    ...
    filters: Model.Filters.initialEnduserCredentialFilters
}
...
export const enduserCredentialReducer = createReducer(
    ...
    on(
        ...
        (state, { response }) => ({ 
            ...state, 
            enduserCredentials: enduserCredentialEntityAdapter.setMany(response.results, state.enduserCredentials),
