...
@Directive({
    selector: '[zwpBidirectionalScroll]'
})
export class BidirectionalScrollDirective implements OnChanges {
    ...
    constructor(private el: ElementRef) {
        ...
        nativeEl.style.setProperty('height', '100%')
        nativeEl.style.setProperty('max-height', '100%')
