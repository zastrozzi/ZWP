...
export const keyboardShortcutEntityAdapter: EntityAdapter<KeyboardShortcutEntity> =
    createEntityAdapter<KeyboardShortcutEntity>()
...
export const keyboardReducer = createReducer(
    ...
    on(KeyboardActions.setTrackingActive, (state, { active }) => ({ ...state, trackingActive: active })),
    on(KeyboardActions.recordKeydown, (state, { keyCode }) => ({
        ...state,
        activeKeyCodes: arrayDistinctUpsert(state.activeKeyCodes, keyCode),
    })),
    on(KeyboardActions.recordKeyup, (state, { keyCode }) => ({
        ...state,
        activeKeyCodes: arrayDistinctRemove(state.activeKeyCodes, keyCode),
    })),
