...
@Component({
    selector: 'zwp-file-explorer-old-compact-list',
            ...
            <ng-container *ngIf="groupingViewMode$ | async as groupingViewMode">
                ...
                <div *ngIf="groupingViewMode === groupingViewModeItemType" fxLayout="row">
                    <div *ngIf="explorerAllDirectories$ | async as allDirectories" fxLayout="column" fxFlex="grow">
                        ...
                        <div fxLayout="row" fxFlex="grow" cdkScrollable>
                            <div
                                fxLayout="column"
                                fxFlex="grow"
                                cdkDropList
...
export class FileExplorerOldCompactListComponent implements AfterViewInit, OnDestroy {
    ...
    openContextMenu(event: any, item: Model.FileDataItem) {
